...
VALUES
    ('Reverse a string', 'Write a function to reverse a string', 'reverseString :: String -> String\nreverseString s = reverse s'),
    ('Is Prime', 'Write a function to check if a number is prime', 'isPrime :: Int -> Bool\nisPrime n = n > 1 && all (\\i -> n `mod` i /= 0) [2..floor (sqrt (fromIntegral n))]'),
    ('Factorial Number', 'Write a function to compute the factorial of a number', 'factorial :: Int -> Int\nfactorial 0 = 1\nfactorial n = n * factorial (n-1)');
...
VALUES
    ...
    (3, 3); -- Factorial in Functional Data Structures
...
VALUES
    ...
    (4, 1); -- Student 4 solved Reverse string

-- Insert dummy data into the testcase table
INSERT INTO
    testcase (exercise_id, testcase_no)
VALUES
    (1, 1), -- Test case 1 for reverse string
    (2, 1), -- Test case 1 for prime check
    (3, 1); -- Test case 1 for factorial
...
VALUES
    ...
    (3, 1, 'integer', '120', TRUE); -- Expected output for factorial
